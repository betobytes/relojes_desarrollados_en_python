...
frame5 = Frame(ventana, bg='grey10')
...
canvas1= Canvas(frame1, bg='gray10', width=200, height =200,highlightthickness=0)
canvas1.grid(column=0,row=0, sticky='nsew')
canvas2= Canvas(frame2, bg='gray10', width=200, height =200,highlightthickness=0)
canvas2.grid(column=0,row=0, sticky='nsew')
canvas3= Canvas(frame3, bg='gray10', width=200, height =200,highlightthickness=0)
...
texto_milisegundos  = canvas3.create_text(1,1, text='mili seg', font=('Arial',10,'bold'), fill= 'White')

circulo1 = canvas1.create_oval(10,10,100,100, outline='cyan',width=1)
circulo2 = canvas2.create_oval(10,10,100,100, outline='cyan',width=1)
circulo3 = canvas3.create_oval(10,10,100,100, outline='cyan',width=1)
...
def vueltas():
	...
	if click_lectura == 1:
		lectura1.config(text='{} → {}:{}:{}'.format(click_lectura, mi,se,ml), fg = 'green2', bg='gray10')
	elif  click_lectura ==2:
		lectura2.config(text='{} → {}:{}:{}'.format(click_lectura, mi,se,ml), fg = 'green2', bg='gray10')
	elif click_lectura ==3:
		lectura3.config(text='{} → {}:{}:{}'.format(click_lectura, mi,se,ml), fg = 'green2', bg='gray10')
	elif  click_lectura ==4:
		lectura4.config(text='{} → {}:{}:{}'.format(click_lectura, mi,se,ml), fg = 'green2', bg='gray10')
	elif click_lectura == 5:
		lectura5.config(text='{} → {}:{}:{}'.format(click_lectura, mi,se,ml), fg = 'green2', bg='gray10')
	elif  click_lectura ==6:
		lectura6.config(text='{} → {}:{}:{}'.format(click_lectura, mi,se,ml), fg = 'green2', bg='gray10')
		click_lectura = 0
...
stop = Button(frame5, text = 'parar', relief = "raised",bd=5, bg='orange', font=('Arial', 12, 'bold'), width =20, command = stop_boton)
stop.grid(column=0, row=0, padx =10, pady=10, sticky='nsew')

inicio = Button(frame5, text = 'iniciar',relief = "raised",bd=5,  bg='green2', font=('Arial', 12, 'bold'), width =20, command = iniciar_pausar)
inicio.grid(column=0, row=0, padx =10, pady=10, sticky='nsew')

vuelta = Button(frame5, text = 'vuelta',relief = "raised", bd=4, bg='cyan', font=('Arial', 12, 'bold'), width =20, command = vueltas)
vuelta.grid(column=1, row=0,padx =10, pady=10, sticky='nsew')

fin = Button(frame5, text = 'restablecer',relief = "raised",bd=4,  bg='red', font=('Arial', 12, 'bold'), width =20, command = reiniciar)
